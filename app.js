...
// Ensure public/images exists for uploaded images (used by multer when not using Cloudinary)
...
// Helper for image URLs (handles Cloudinary full URLs vs local /images/ path)
